// 生成模拟目标数据
export const generateMockTargets = () => [
    {
        id: 'target_1',
        ip: '192.168.1.10',
        name: 'Web Server',
...
// 生成模拟攻击方法
export const generateMockAttackMethods = () => [
    'VULNERABILITY SCAN',
    'BRUTE FORCE',
    'SQL INJECTION',
    'COMMAND INJECTION',
...
// 生成模拟网络拓扑
export const generateMockNetworkTopology = () => ({
    nodes: [
        {
            id: 'central',
            ip: '192.168.1.10',
...
// 生成模拟扫描结果
export const generateMockScanResults = (targetId) => ({
    targetId,
...
// 生成模拟流量数据
export const generateMockTrafficData = (timeRange = '6h') => {
        ...
        return {
            ...
            time: timeRange === '1h' ?
                ...
                timeRange === '6h' ?
                    timestamp.getHours() :
                    timestamp.getDate(),
            value: Math.floor(Math.random() * 100) + 120, // 120-220K
            incoming: Math.floor(Math.random() * 50) + 60,
            outgoing: Math.floor(Math.random() * 50) + 60
        }
    })
    ...
    return {
        ...
        summary: {
            ...
            average: Math.floor(data.reduce((sum, d) => sum + d.value, 0) / data.length),
