...
const attackLogs = ref([
  { id: 1, time: '10:34:21', target: '192.168.1.10', description: 'SQL注入攻击尝试被检测到', severity: 'critical'},
  { id: 2, time: '10:32:49', target: '192.168.1.30', description: '命令注入攻击尝试', severity: 'warning' },
  { id: 3, time: '10:30:15', target: '192.168.1.20', description: '暴力破解攻击已阻止', severity: 'critical' },
  { id: 4, time: '10:27:58', target: '192.168.1.10', description: '系统漏洞扫描完成', severity: 'info' },
  { id: 5, time: '10:25:33', target: '192.168.1.40', description: '异常网络流量检测', severity: 'warning' }
])
...
.log-item.critical .log-indicator {
...
@media (max-width: 1200px) {
  ...
  .left-sidebar, .right-sidebar, .center-area {
    display: grid;
...
@media (max-width: 768px) {
  ...
  .main-content, .left-sidebar, .right-sidebar, .center-area {
    grid-template-columns: 1fr;
    padding: 8px;
    gap: 12px;
  }
